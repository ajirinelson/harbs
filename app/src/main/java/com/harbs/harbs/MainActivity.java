...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int APP_REQUESTCODE = 7117;
    ...
    void loginSet(){
        ...
        startActivityForResult(intent, APP_REQUESTCODE);
    }

    @OnClick(R.id.txt_skip)
    void skipLoginButtonHome(){
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==APP_REQUESTCODE){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dexter.withActivity(this)
            ...
            public void onPermissionsChecked(MultiplePermissionsReport report) {
                ...
                AccessToken acccesstoken = AccountKit.getCurrentAccessToken();
