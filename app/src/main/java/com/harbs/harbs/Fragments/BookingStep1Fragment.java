...
import com.harbs.harbs.Adapter.MySalonAdapter;
import com.harbs.harbs.Common.Common;
import com.harbs.harbs.Common.SpacesItemDecoration;
import com.harbs.harbs.Interface.IAllSalonLoadListener;
import com.harbs.harbs.Interface.IBranchLoadListener;
...
public class BookingStep1Fragment extends Fragment implements IAllSalonLoadListener, IBranchLoadListener {
    ...
    @Override
    public void onAllSalonLoadSuccess(List<String> areaName) {

        spinner.setItems(areaName);
    ...
    private void loadBranchOfCity(String cityName) {
        ...
        branchRef = FirebaseFirestore.getInstance().collection("AllSalon").document(cityName)
                .collection("Branch");
